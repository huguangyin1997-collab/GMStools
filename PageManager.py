...
class PageManager:
    def __init__(self, parent_widget=None):  # 新增 parent_widget 参数
        self.left_menu = None
        self.stacked_widget = None
        self.pages = {}
        self.disclaimer_accepted = False
        self.parent_widget = parent_widget  # 保存父部件引用
        self.setup_ui()
        self.create_pages()
        self.add_menu_items()
    ...
    def on_menu_item_clicked(self, key):
        ...
        if not self.disclaimer_accepted:
            # 这里可以使用父窗口作为参数，但 QMessageBox 可以接受 None
